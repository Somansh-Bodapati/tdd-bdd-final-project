...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_with_empty_id(self):
        """Test that updating with an empty ID raises DataValidationError"""
        # Arrange
        product = Product(
            name="Test Product",
    ...
    def test_deserialize_invalid_type_available(self):
        """It should raise DataValidationError when deserializing with invalid type for available"""
        invalid_data = {
            "name": "Test Product",
            "description": "Test Description",
            "price": "10.0",
    ...
    def test_deserialize_invalid_category(self):
        """It should raise DataValidationError when deserializing with invalid category"""
        invalid_data = {
            "name": "Test Product",
            "description": "Test Description",
            "price": "10.0",
    ...
    def test_deserialize_invalid_product(self):
        """It should raise DataValidationError when deserializing with invalid product data"""
        # Invalid data missing the 'name' field
        invalid_data = {
